...
#define NUM_THREADS 1 // Set the desired number of threads
...
int main(int argc, char **argv) {
  ...
  #pragma omp parallel default(none)\
              shared(pPng,fDeltaX,fDeltaY,nTotalIterationsCount)\
              private(x,y,x2,y2,cx,cy,n,i,j)
  {
