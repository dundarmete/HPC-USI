...
void diffusion(const data::Field &U, data::Field &S)
{
    ...
    if(domain.neighbour_north>=0) {
        ...
        // post receive
        MPI_Irecv(bndN.data(), nx, MPI_DOUBLE, domain.neighbour_north, domain.neighbour_north,
        ...
        // post send
        MPI_Isend(buffN.data(), nx, MPI_DOUBLE, domain.neighbour_north, domain.rank,
            comm_cart, requests+num_requests);
        num_requests++;
    }
    ...
    if (domain.neighbour_south >= 0) {
        // post receive
        MPI_Irecv(bndS.data(), nx, MPI_DOUBLE, domain.neighbour_south, domain.neighbour_south,
            comm_cart, requests + num_requests);
        num_requests++;
        ...
        // post send
        MPI_Isend(buffS.data(), nx, MPI_DOUBLE, domain.neighbour_south, domain.rank,
            comm_cart, requests + num_requests);
        num_requests++;
    }
    ...
    if (domain.neighbour_east >= 0) {
        // post receive
        MPI_Irecv(bndE.data(), ny, MPI_DOUBLE, domain.neighbour_east, domain.neighbour_east,
            comm_cart, requests + num_requests);
        num_requests++;
        ...
        // post send
        MPI_Isend(buffE.data(), ny, MPI_DOUBLE, domain.neighbour_east, domain.rank,
            comm_cart, requests + num_requests);
        num_requests++;
    }
    ...
    if (domain.neighbour_west >= 0) {
        // post receive
        MPI_Irecv(bndW.data(), ny, MPI_DOUBLE, domain.neighbour_west, domain.neighbour_west,
            comm_cart, requests + num_requests);
        num_requests++;
        ...
        // post send
        MPI_Isend(buffW.data(), ny, MPI_DOUBLE, domain.neighbour_west, domain.rank,
            comm_cart, requests + num_requests);
        num_requests++;
    }
